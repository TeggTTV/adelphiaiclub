...
import { eboardMembers as staticEboard, upcomingEvents as staticUpcomingEvents } from "@/lib/data"
  ...
  try {
    ...
    const [events, projects] = await Promise.all([
      ...
      for (const ev of staticFuture) {
        ...
        const exists = combinedEvents.some((c) => c.title === ev.title && c.date === ev.date)
