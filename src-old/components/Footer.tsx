...
const Footer = () => {
	return (
		<footer
			id="connect"
			className="relative bg-transparent py-12 sm:py-16 md:py-20 overflow-hidden border-t border-white/5"
		>
			...
			<div className="container mx-auto px-4 sm:px-6 md:px-8 relative z-10">
				<div className="max-w-4xl mx-auto text-center">
					...
					>
						Join our community and stay updated with the latest in
						AI
					</motion.p>
					...
					>
						{[
							{
								icon: FaGithub,
								href: 'https://github.com/adelphiaisociety',
								label: 'GitHub',
							},
							{
								icon: FaInstagram,
