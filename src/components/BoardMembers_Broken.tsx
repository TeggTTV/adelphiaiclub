			...
			<div className="w-full container mx-auto px-4 sm:px-6 relative z-10">
				...
				>
					{boardMembers.map((member, index) => (
						<motion.div
							key={member.name}
							className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-white/10 shadow-lg hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 relative overflow-hidden group flex flex-col"
							variants={{
								hidden: { 
									opacity: 0, 
									y: 60,
						...
						>
							...
							<div className="flex flex-col items-center text-center relative z-10 flex-1">
								...
								<p className="text-blue-400 font-semibold text-base mb-3">
									{member.role}
								</p>
								<p className="text-gray-200 text-sm leading-relaxed flex-1 flex items-center justify-center">
									{member.description}
								</p>
							</div>
						</motion.div>
